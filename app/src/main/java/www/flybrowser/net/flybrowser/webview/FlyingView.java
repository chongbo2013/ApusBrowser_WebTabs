...
public class FlyingView {
    ...
    public FlyingView(Activity activity, String url, boolean darkTheme, boolean isIncognito, BrowserController controller) {
        ...
        mWebView = new TitleBarWebView(mActivity);
...
//        }
    ...
    public synchronized void onDestroy() {
        if (mWebView != null) {
            ...
            mWebView.setEmbeddedTitleBar(null);
            mWebView = null;

        }
        top_titlerbar_layout=null;
    }
    ...
    View top_titlerbar_layout;
    public void setTitleBar(FrameLayout top_titlerbar_layout) {
        this.top_titlerbar_layout=top_titlerbar_layout;
        mWebView.setEmbeddedTitleBar(mActivity.getLayoutInflater().inflate(R.layout.head,null));
    }
    ...
    private class CustomGestureListener extends SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            if (scrollY <= BrowserActivity.TITLE_BAR_HIGHT) {
                scrollY=Math.min(scrollY,BrowserActivity.TITLE_BAR_HIGHT);
                ViewHelper.setTranslationY(top_titlerbar_layout, -scrollY);
            }
            return super.onScroll(e1, e2, distanceX, distanceY);
        }
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            float delX=Math.abs(e2.getX()-e1.getX());
            float delY=Math.abs(e2.getY()-e1.getY());
            if(delX>delY){
                return super.onFling(e1, e2, velocityX, velocityY);
            }
    ...
    public void onScrollUp() {
        startAnimation(top_titlerbar_layout, -BrowserActivity.TITLE_BAR_HIGHT);
    }


    public void onScrollDown() {
        startAnimation(top_titlerbar_layout, 0);
    }
